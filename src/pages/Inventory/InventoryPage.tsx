    ...
    return (
        <div className="p-4 md:p-8 max-w-6xl mx-auto space-y-10 pb-24 bg-slate-50/30 min-h-screen">
            <header className="flex justify-between items-end border-b pb-6">
                <div>
                    <h1 className="text-4xl font-black text-slate-900 tracking-tighter">Análisis de Materiales</h1>
                    <p className="text-slate-500 font-medium">Gestiona y analiza el rendimiento de tu materia prima.</p>
                </div>
